...
df = pd.read_csv("level_kitchen_bad_reviews.csv", delimiter=';')
...
# Теперь графики
data = {
    "Проблема": ["Доставка", "Качество еды", "Сервис/поддержка", "Цена", "Порции","состав/обман"],
    "Упоминания": [26, 19, 11, 7, 8,4]
}
